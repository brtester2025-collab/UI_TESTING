...
test.describe("Product Page", () => {
  ...
  test("checking the product has price,image and description", async ({
    page,
  }) => {
    ...
    await expect(
      firstProduct.locator(".inventory_item_description"),
    ).toBeVisible();
  ...
  test("To add the multiple products and check the cart count", async ({
    page,
  }) => {
  ...
  test("Cart badge is not visible when no product is added to the cart", async ({
    page,
  }) => {
    await page.locator('[data-test="add-to-cart-sauce-labs-backpack"]').click();
