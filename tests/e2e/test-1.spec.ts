...
test("test", async ({ page }) => {
  ...
  await page
    .getByRole("banner")
    .getByRole("link", { name: "Makeup Artist" })
    .click();
  await page
    .getByRole("banner")
    .getByRole("link", { name: "Banquet Hall" })
    .click();
  ...
  await page
    .getByRole("banner")
    .getByRole("link", { name: "Photographer" })
    .click();
  await page
    .getByRole("banner")
    .getByRole("link", { name: "Decorators" })
    .click();
  await page
    .getByRole("banner")
    .getByRole("button", { name: "User Sign In" })
    .click();
  ...
  await page
    .getByRole("textbox", { name: "Enter Verification Code Enter" })
    .click();
  await page
    .getByRole("textbox", { name: "Enter Verification Code Enter" })
    .fill("0000");
  ...
  await page
    .getByRole("banner")
    .getByRole("button", { name: "Chat Now" })
    .click();
  await page
    .locator("app-chat")
    .getByRole("button")
  ...
  await page
    .getByRole("banner")
    .getByRole("button", { name: "List Your Business FREE" })
    .click();
  await page
    .getByRole("banner")
    .getByRole("button")
